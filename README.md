...
|정보이론|05. 엔트로피 손실 (Binary Cross Entropy, Cross Entropy) - Deep dive|[click](https://youtu.be/jezdkq55Xwk)|[link](https://github.com/kafa46/deeplearning_math/blob/master/05_information_theory/05_entropy_loss.pdf)|없음|
